...
const INSTRUCCIONS_MENU_ELEMENT =
  BOARD_MENU_ELEMENT.querySelector("#instructions-menu");
const CONTENT_INSTRUCTIONS_ELEMENT = INSTRUCCIONS_MENU_ELEMENT.querySelector(
  "#content-instructions"
);
const ARRAY_PAGES =
  CONTENT_INSTRUCTIONS_ELEMENT.querySelectorAll("div[name='page']");

const BOARD_GAME_ELEMENT = BOARD_ELEMENT.querySelector("#board-game");
const BOARD_GAME_FINISH_ELEMENT =
  BOARD_ELEMENT.querySelector("#board-game-finish");
